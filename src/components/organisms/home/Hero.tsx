    ...
    <div className="w-full min-h-screen relative">
      ...
      <div className="z-1000 absolute w-full h-screen grid grid-cols-2 gap-6 px-16">
        ...
        <div className="flex flex-col items-start justify-center gap-7">
          ...
          <div className="flex gap-4 max-2xl:h-11 2xl:h-16 max-2xl:max-w-44.75 2xl:max-w-58 max-2xl:rounded-r6 2xl:rounded-r10 pl-5.5 pr-1.5 py-1 items-center justify-between bg-cocoa w-full text-white max-2xl:text-[14px] 2xl:text-[18px] font-medium">
