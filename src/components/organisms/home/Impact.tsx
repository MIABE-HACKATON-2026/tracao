const Impact = () => {
  return (
    <div className="flex flex-col items-start gap-16 h-screen p-16">
      <div className="max-w-[480px] text-[32px] leading-[42px] 2xl:text-[36px] 2xl:leading-[46px] font-medium  text-cocoa">Driving transparency and sustainability</div>
      <div className="flex flex-col gap-5 w-full items-center">
        <div className="group duration-300 hover:w-full hover:text-harvest hover:bg-cocoa w-[92%] h-[124.5] 2xl:h-[15vh] text-cocoa rounded-r9 pl-20 py-2 pr-2 flex items-center justify-between bg-cocoa-10">
          <div className="text-[26px] leading-[42px]">Maintain access to EU markets</div>
        ...
        <div className="group duration-300 hover:w-full hover:text-harvest hover:bg-cocoa w-[92%] h-[124.5] 2xl:h-[15vh] text-cocoa rounded-r9 pl-20 py-2 pr-2 flex items-center justify-between bg-cocoa-10">
          <div className="text-[26px] leading-[42px]">Protect smallholder farmers</div>
        ...
        <div className="group duration-300 hover:w-full hover:text-harvest hover:bg-cocoa w-[92%] h-[124.5] 2xl:h-[15vh] text-cocoa rounded-r9 pl-20 py-2 pr-2 flex items-center justify-between bg-cocoa-10">
          <div className="text-[26px] leading-[42px]">Reduce fraud and illegal trade</div>
        ...
        <div className="group duration-300 hover:w-full hover:text-harvest hover:bg-cocoa w-[92%] h-[124.5] 2xl:h-[15vh] text-cocoa rounded-r9 pl-20 py-2 pr-2 flex items-center justify-between bg-cocoa-10">
          <div className="text-[26px] leading-[42px]">Enable sustainable agriculture</div>
